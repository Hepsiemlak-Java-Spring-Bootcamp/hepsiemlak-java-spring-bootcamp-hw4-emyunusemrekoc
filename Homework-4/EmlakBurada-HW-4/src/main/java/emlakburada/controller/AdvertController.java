...
public class AdvertController {
    ...
    public ResponseEntity<AdvertResponse> findAdvertByAdvertId(@PathVariable(required = false) int advertNo) {
        return new ResponseEntity<>(advertService.findAdvertByAdvertId(advertNo), HttpStatus.OK);
    }
